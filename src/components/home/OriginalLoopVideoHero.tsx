  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1680px] px-4 md:px-6 lg:px-10">
        ...
        <div className="mx-auto max-w-[76rem] px-1 pt-8 text-center md:max-w-[88rem] md:pt-10">
          ...
          <p className="mt-2 whitespace-nowrap font-sans text-[11px] leading-5 tracking-[0.02em] text-neutral-500 md:text-[12.5px]">
            1962년 대구에서 시작해 3대째, 영진원단은 한국 선염 면원단의 기준을 만들어 왔습니다.
          </p>
        </div>
      </div>
    </section>
